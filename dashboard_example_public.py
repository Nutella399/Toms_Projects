...
df = pd.read_excel(' Hidden for security reasons :( ')
...
app.layout = html.Div(
                    [
                        html.Div(
                            [
                                html.Img(
                                    src= 'https://www.connect2concepts.com/wp-content/uploads/2017/02/connect2concepts.jpg',
...
def update_figure(schools, injury_type, start_date, end_date, activs, selector):
    ...
    traceheat = go.Heatmap(z=z_array, x=lt, y = injury_type, 
                           zsmooth = 'True', colorscale = 'Viridis',)
